...
// Mock the ToolStatusIndicator component
vi.mock("../ToolStatusIndicator", () => ({
  ToolStatusIndicator: ({ toolInvocation }: { toolInvocation: any }) => (
    <div>Working on {toolInvocation.args?.path?.split('/').pop() || 'file'}</div>
  ),
}));
